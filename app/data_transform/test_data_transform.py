...
class TestDateTimeTransformer(unittest.TestCase):
    ...
    def test_extract_element_from_date(self):
        ...
        # Data to test replace
        data_loader.insert_row('test-table', 0, ['test'], dict([('test', '11/3/2016')]))
        ...
        try:
            ...
            date_time_transformer.extract_element_from_date(0, 'test-table', 'test', 'MONTH')
            ...
            self.assertEqual(table.rows[0][2], 3)
        finally:
            data_loader.delete_table('test-table', 'schema-0')
    ...
    def test_extract_date_or_time(self):
        ...
        try:
            ...
            # Extract
            date_time_transformer.extract_date_or_time(0, 'test-table', 'test', 'DATE')
            ...
            self.assertEqual(table.rows[0][2], '2016-03-11')
        finally:
            data_loader.delete_table('test-table', 'schema-0')
